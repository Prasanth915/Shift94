...
const platforms = [
  ...
  },
  {
    id: 'github',
    name: 'GitHub',
    description: 'Push to your GitHub repositories',
    available: true,
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    id: 'instagram',
    name: 'Instagram',
    description: 'Share visuals with your followers',
    available: false,
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    id: 'portfolio',
    name: 'Portfolio Site',
    description: 'Publish to your personal portfolio',
    available: false,
    icon: (
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-xs text-zinc-500">
        Select platforms to publish your project to. {value.length > 0 && `${value.length} selected`}
      </p>
    </div>
  );
}
